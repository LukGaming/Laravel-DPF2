...
@section('conteudo')
    ...
    <form method="POST" action="{{ route('configpcjogador.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="processador" name="processador" value="{{ old('processador') }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="memoria_ram" name="memoria_ram" value="{{ old('memoria_ram') }}">
        </div>
        <div class="form-group">
